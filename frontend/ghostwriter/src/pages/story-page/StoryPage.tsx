...
function StoryPage() {
  // console.log("StoryPage called")
    ...
    // const response = "A fish flying over the rainbowThis is an example story\n that will be replaced by one generated by the GPT Ghostwriter. \nLorem ipsum dolor "
    let split = response.split('\n');

    //TODO remove all empty elements of split
    let filtered = split.filter((par) => {
      if (!(par.trim() === "")) {
        return true;
      } else {
        return false;
            ...
            <Typewriter
              onInit={(typewriter) => {
                trimmed.forEach((par) => {
                  ...
                  // TODO: when the state parNum is updated, call the typewriter to start writing the next paragraph
